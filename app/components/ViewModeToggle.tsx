    ...
    <div className="view-mode-toggle">
      <div className="toggle-cont">
        <input
          ...
          type="checkbox"
          checked={isLogical}
          onChange={() => onChange(isLogical ? "physical" : "logical")}
          aria-label={isLogical ? "Modo Lógico ativo" : "Modo Físico ativo"}
        />
        <label className="toggle-label" htmlFor="view-mode-toggle">
      ...
      <span className="absolute -bottom-5 left-1/2 -translate-x-1/2 whitespace-nowrap text-[9px] font-bold text-slate-400 uppercase tracking-wider pointer-events-none">
        {isLogical ? "Lógico" : "Físico"}
      </span>
    </div>
  );
}
